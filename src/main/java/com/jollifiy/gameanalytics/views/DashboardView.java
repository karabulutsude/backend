...
import com.jollifiy.gameanalytics.service.DashboardService;
...
public class DashboardView extends VerticalLayout {
    ...
    public DashboardView(DashboardService dashboardService, AnalyticsService analyticsService) {
        ...
        VerticalLayout playerCard = createStatCard("Toplam Oyuncu", String.valueOf(dashboardService.getTotalPlayerCount()), VaadinIcon.USERS.create(), "#3b82f6");
        VerticalLayout analyticsCard = createStatCard("Toplam Analitik Olayı", String.valueOf(dashboardService.getTotalAnalyticsCount()), VaadinIcon.CHART.create(), "#10b981");
        VerticalLayout progressCard = createStatCard("İlerleme Kayıtları", String.valueOf(dashboardService.getTotalProgressCount()), VaadinIcon.FLAG.create(), "#8b5cf6");

        // En yüksek skoru dinamik olarak bulup kart oluşturuyoruz
    ...
    // En yüksek skoru veritabanından bulan yardımcı metot
    private String getMaxScoreDetails() {
        try {
            List<Analytics> events = analyticsService.getAllEvents();
    ...
    private void updateTableList() {
        try {
            List<Analytics> allEvents = analyticsService.getAllEvents();
